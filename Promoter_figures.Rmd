...
ggplot(Total.Non_B.enrichment[Mutation_type=="Substitutions"])+
  geom_line(aes(x=Position,y=Enrrichment/Enrrichment.mean, colour=Feature)) +
  geom_ribbon(aes(x=Position,y=Enrrichment/Enrrichment.mean, fill=Feature, ymin=Enrrichment.Lower/Enrrichment.Lower.mean, ymax=Enrrichment.Upper/Enrrichment.Upper.mean), alpha=0.3) +
  xlim(c(-250,250)) +
  #facet_wrap( . ~ Mutation_type, scales="free_y" ) +
...
```{r}
TF_NB_HEPG2 <- fread('/Users/gp7/Google_Drive/Results/Promoters/Vulcano/TF_NB_HEPG2.txt')
TF_NB_K562 <- fread('/Users/gp7/Google_Drive/Results/Promoters/Vulcano/TF_NB_K562.txt')
TF_NB_neuronal <- fread('/Users/gp7/Google_Drive/Results/Promoters/Vulcano/TF_NB_neuronal.txt')
...
fig3.i  <- ggplot(TF_NB_K562) +
  ...
  #xlim(c(-2,2)) +
  ylim(c(0,115)) +
  geom_text_repel(data=TF_NB_K562[!is.na(sig) & -log10(p.value)>35,],
                  aes(Delta, -log10(p.value),label=Gene, colour=sig  ),
                  size =  3,
                  point.padding = NA,
                  fontface = "bold", 
...
```{r}
TF_NB_HEPG2.uncor <- fread('/Users/gp7/Google_Drive/Results/Promoters/Vulcano/TF_NB_HEPG2_uncor.txt')
TF_NB_K562.uncor <- fread('/Users/gp7/Google_Drive/Results/Promoters/Vulcano/TF_NB_K562_uncor.txt')
TF_NB_neuronal.uncor <- fread('/Users/gp7/Google_Drive/Results/Promoters/Vulcano/TF_NB_neuronal_uncor.txt')
